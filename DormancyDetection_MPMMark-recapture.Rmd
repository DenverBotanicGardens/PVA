...
foo <- lapply(MPM.plots, function(x) lapply(x, function(y) ifelse(is.null(y), NA, lambda(y))))

MPMlam <- data.frame(Lambda = do.call(c,lapply(MPM.plots, function(x) do.call(c, lapply(x, function(y) ifelse(is.null(y), NA, lambda(y)))))))
MPMlamdf <- MPMlam %>%
