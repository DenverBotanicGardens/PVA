#' @title Stage based PVA
#' @description 
#' 
#' @return Each lambda for the duration of the study as "Sitemu"	
#' r squared	as "R.sq" 
#' mu with lower and upper 95% CI as "mu.s" with three columns of "mu.s$fit", "mu.s$lwr", 
#'    and "mu.s$upr"
#'  the set of year intervals of the start year of study and each consecutive addition 
#'    of years as "years", "years$RangeStart" and "years$RangeEnd"
