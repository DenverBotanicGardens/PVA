...
#Just linear factors
out <- grep("Total.Alivelogtransformed.y", names(ps.cor[grep("transformed",names(ps.cor))]))
step2 <- as.formula(paste("Total.Alivelogtransformed.y ~ ",
                          paste(names(ps.cor)[grep("transformed",names(ps.cor))][-out],
                                collapse = "+")))
...
t.test(Percent..Browsinglogtransformed~Fence, data = ps.asmi.t)
...
t.test(ps.asmi.t$Percent..Browsinglogtransformed[ps.asmi.t$Year<2007&
                                                   ps.asmi.t$Fence=="y"],
       ps.asmi.t$Percent..Browsinglogtransformed[ps.asmi.t$Year>=2007&
                                                   ps.asmi.t$Fence=="y"])
