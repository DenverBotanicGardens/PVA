...
```{r}
ps.asmi <- read.csv(path.expand("Q:/Research/All_Projects_by_Species/Astragalus SPECIES/Astragalus_microcymbus/Asmi_Excel/Yearly Summaries/2015_asmi/PlotSummary_2015_dev.csv"))

head(ps.asmi)

ps.cor <- subset(merge(ps.asmi, ps.asmi, by = c("Site","Plot")), Year.x == Year.y - 1)
head(ps.cor)
