...
asmi.raw <- asmi.raw[!is.na(asmi.raw$AsMi_data_id),]
...
ggplot(season, aes(Prev12, ppt.fall))+
  geom_line()

ggplot(season, aes(Prev12, ppt.winter))+
  geom_line()
```
...
#Candidate models  
glm1 <- glm(Total.Fruit ~ Year, family = poisson(link = 'log'), data = ps.asmi.reduced)
glm2 <- glm(Total.Fruit ~ Year*as.factor(Site), family = poisson(link = 'log'), data = ps.asmi.reduced)
glm3 <- glm(Total.Fruit ~ Year*Creek, family = poisson(link = 'log'), data = ps.asmi.reduced) #Need add creek!
glm4 <- glm(Total.Fruit ~ Year*Fence, family = poisson(link = 'log'), data = ps.asmi.reduced)
glm5 <- glm(Total.Fruit ~ 1, family = poisson(link = 'log'), data = ps.asmi.reduced)
glm6 <- glm(Total.Fruit ~ as.factor(Site), family = poisson(link = 'log'), data = ps.asmi.reduced)
glm7 <- glm(Total.Fruit ~ Creek, family = poisson(link = 'log'), data = ps.asmi.reduced) 
glm8 <- glm(Total.Fruit ~ Fence, family = poisson(link = 'log'), data = ps.asmi.reduced)
