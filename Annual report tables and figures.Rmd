...
p2CC <- ggplot(ps.asmi[ps.asmi$Year > 2013 & 
...
#WTF is happening with AGG and Dormants at Cebolla Creek Mid?
```{r}
AGG_dorm <- ps.asmi[ps.asmi$Year > 2013 & 
                 ps.asmi$Year < currentyr & ps.asmi$Site < 3,]

AGG_only <- ps.asmi[ps.asmi$Site < 3 & ps.asmi$Year > 2013,]

table(AGG_dorm$Total.Alive,AGG_dorm$Year)
table(AGG_only$Total.Plants,AGG_only$Year)
```
