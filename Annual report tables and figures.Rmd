...
lm6 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,c(per.fl,grep(".y", names(asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2013),collapse="|"),
                                   names(asmimerglag))])))])

# lm6 2013 only prev 12 months of previous year, lag? 
lm13 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,c(per.fl,grep(".x", names(asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2013),collapse="|"),
                                   names(asmimerglag))])))])
