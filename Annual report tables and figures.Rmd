...
lm4 <- lm(Total.Fruitlogtransformed.y ~ Year.x*Fence.x, ps.cor)
 lm5 <- lm(Total.Fruitlogtransformed.y ~ 1, ps.cor)
...
lm5 <- lm(X..Flowered.1logtransformed.x ~ 1, ps.cor)
...
table(asmi.raw$Browsing...Status) 
nrow(asmi.raw) #13806->16377->17817
...
cebolla$status <- ordered(cebolla$status, levels = stages)N
...
table(Fate = asmi.all2$fate, Stage = asmi.all2$stage)
...
p2SBC <- ggplot(ps.asmi.t[ps.asmi.t$Total.Plants>0 & ps.asmi.t$Year > 1995 &
                 ps.asmi.t$Year < currentyr & ps.asmi.t$Creek == "SouthBeaver",], 
...
p4SBC <- ggplot(ps.asmi.t[ps.asmi.t$Total.Plants>0 & ps.asmi.t$Creek == "SouthBeaver",], 
...
aggregate(PercentPlants ~ Site + Year, AGG.pplot, function(x) mean(x, na.rm=TRUE))
```

# Annual percent of AGG in 1995 compared to now, by plot (so compared to second year of plots that were added)   
```{r}
# AGG.pplot <- aggregate(Total.Alive ~ Site + Plot + Creek + Year, ps.asmi, function(x) sum(x))
AGG.pplot$PercentAlive95 <- as.numeric(NA)
#Cebolla should all be from 2015
AGG.pplot$PercentAlive95[AGG.pplot$Site<3 & AGG.pplot$Year>2013] <-
  AGG.pplot$Total.Alive[AGG.pplot$Site<3 & AGG.pplot$Year>2013]/
  AGG.pplot$Total.Alive[AGG.pplot$Site<3 & AGG.pplot$Year==2014]

# Do all ignoring that plot 238 and 300 need to be updated to having 1997 as the second year and 598 having 2005 as its second year
AGG.pplot$PercentAlive95[AGG.pplot$Site>2 & AGG.pplot$Year>1994] <-
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year>1994]/
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year==1995]

# 1996 added plots
AGG.pplot$PercentAlive95[AGG.pplot$Site>2 & AGG.pplot$Year>1995 & AGG.pplot$Plot %in% c(238,300)] <-
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year>1995 & AGG.pplot$Plot %in% c(238,300)]/
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year==1996 & AGG.pplot$Plot %in% c(238,300)]

# 2004 addition
AGG.pplot$PercentAlive95[AGG.pplot$Site>2 & AGG.pplot$Year>1995 & AGG.pplot$Plot %in% c(598)] <-
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year>1995 & AGG.pplot$Plot %in% c(598)]/
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year==1996 & AGG.pplot$Plot %in% c(598)]

aggregate(PercentAlive95 ~ Site + Year, AGG.pplot, function(x) mean(x, na.rm=TRUE))
```
...
#Cebolla should all be from 2015
AGG.pplot$PercentAlive96[AGG.pplot$Site<3 & AGG.pplot$Year>2014] <-
  AGG.pplot$Total.Alive[AGG.pplot$Site<3 & AGG.pplot$Year>2014]/
  AGG.pplot$Total.Alive[AGG.pplot$Site<3 & AGG.pplot$Year==2015]

# Do all ignoring that plot 238 and 300 need to be updated to having 1997 as the second year and 598 having 2005 as its second year
AGG.pplot$PercentAlive96[AGG.pplot$Site>2 & AGG.pplot$Year>1995] <-
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year>1995]/
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year==1996]

# 1996 added plots
AGG.pplot$PercentAlive96[AGG.pplot$Site>2 & AGG.pplot$Year>1996 & AGG.pplot$Plot %in% c(238,300)] <-
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year>1996 & AGG.pplot$Plot %in% c(238,300)]/
  AGG.pplot$Total.Alive[AGG.pplot$Site>2 & AGG.pplot$Year==1997 & AGG.pplot$Plot %in% c(238,300)]

# 2004 addition
AGG.pplot$PercentAlive96[AGG.pplot$Site>2 & AGG.pplot$Year>2004 & AGG.pplot$Plot %in% c(598)] <-
