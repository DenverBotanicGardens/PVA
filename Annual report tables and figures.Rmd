...
t.test(X..Browsed.x~Fence.x, data = ps.cor)
t.test(Total.Fruit.x~Fence.x, data = ps.cor[ps.cor$Year.x > 2005,])

t.test(X..Flowered.x~Fence.x, data = ps.cor[ps.cor$Year.x > 2005,])
