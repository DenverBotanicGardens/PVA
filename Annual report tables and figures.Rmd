...
foo <- apply(seqXclass,1,function(x){
  rle(x)
})

##START HERE!! FIND THE preceeding and following stages
valesbeforedormant <- lapply(foo, function(x){
  wd <- which(x[x$values == "0"])
