...
fit <- survfit(Surv(year, surv) ~ site, 
               data = surv.asmi[surv.asmi$length>0,]) 

ggsurvplot(fit, data=surv.asmi[surv.asmi$length>0,], risk.table = FALSE, xlab = "length", ylab="Probability of Reproductive")
