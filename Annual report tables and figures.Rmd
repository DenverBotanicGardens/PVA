...
length(dorms$dorms[dorms$dorms>0])/length(dorms$dorms) # 37%
...
t.test(lmdSD(asmi.pva$fenced.pro.matrix, 2005, currentyr-2),
       lmdSD(asmi.pva$notfenced.pro.matrix, 2005, currentyr-2),
       paired = TRUE)
...
```{r}
t.test(lmdSD(asmi.pva$fenced.pro.matrix, 1996, 2004),
       lmdSD(asmi.pva$fenced.pro.matrix, 2005, currentyr-2))
```
