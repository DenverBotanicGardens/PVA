...
asmi.c %>%
  ...
  dplyr::summarise(mean1980_2022 = mean(value), sd1980_current = sd(value)) 

asmi.c %>%
  pivot_longer(cols = ppt:tmin, names_to = "variable", values_to = "value") %>%
  filter(Year > 1994) %>%
  group_by(Creek, variable) %>%
  dplyr::summarise(mean1995_2022 = mean(value), sd1995_current = sd(value)) 
```
...
ggplot(  aes(tmax_springSummer,surv,color = site))+
  ...
  facet_grid(~ppt_winter_bin, scales = "free", 
             ...
             #                       c(paste(labels4bins$ppt_winter_bin[1]) = "low winter precipitation", 
             #                         paste(labels4bins$ppt_winter_bin[2]) = "mid winter precipitation",
             #                         paste(labels4bins$ppt_winter_bin[3]) = "high winter precipitation"))
             )+
...
A_site1 <- mean(do.call(c,list(all.pva$"1"$"1", all.pva$"22"$"22", all.pva$"32"$"32", all.pva$"42"$"42", all.pva$"52"$"52")))
A_site2 <- mean(do.call(c,list(all.pva$"16"$"16", all.pva$"58"$"58", all.pva$"89"$"89", 
                               all.pva$"90"$"90", all.pva$"96"$"96", all.pva$"98"$"98")))
A_site5 <- mean(do.call(c,list(all.pva$"606"$"606", all.pva$"607"$"607", 
                               all.pva$"608"$"608", all.pva$"609"$"609", all.pva$"610"$"610")))
A_site15 <- mean(do.call(c,list(all.pva$"8"$"8", all.pva$"578"$"578", all.pva$"581"$"581", all.pva$"799"$"799")))
A_site19 <- mean(do.call(c,list(all.pva$"300"$"300", all.pva$"512"$"512", 
                                all.pva$"513"$"513", all.pva$"514"$"514", all.pva$"515"$"515")))
A_site26 <- mean(do.call(c,list(all.pva$"238"$"238", all.pva$"480"$"480", all.pva$"598"$"598", 
                                all.pva$"611"$"611", all.pva$"614"$"614")))
...
lapply(list(A_site1,A_site2,A_site5,A_site15,A_site19,A_site26), function(x){ 
  ...
  matF <- x
  matF[2:4,] <- 0
  lifeTimeRepEvents(matU = matU, matF = matF, startLife = 1)
  })
lapply(list(A_site1,A_site2,A_site5,A_site15,A_site19,A_site26), function(x) { 
  matU <- x
  matU[1,3] <- 0
