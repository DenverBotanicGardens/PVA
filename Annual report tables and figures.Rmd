...
# rawdatapath2 <- paste("Q:/Research/All_Projects_by_Species/Astragalus SPECIES/Astragalus_microcymbus/Asmi_Excel/Yearly Summaries/",
...
savepath <- paste("C:/Users/DePrengm/Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Astragalus-microcymbus/Astragalus-microcymbus_AnnualReports/", currentyr, "_Astragalus-microcymbus_AnnualReport/", collapse = '', sep = '')
...
asmilatlong <- read.csv("C:\Users\deprengm\Denver Botanic Gardens\Conservation - General\AllProjectsBySpecies\Astragalus-microcymbus\Astragalus-microcymbus_AnnualReports\2016_Astragalus-microcymbus_AnnualReport\UTM_asmiplots.csv")
...
# savepath <- paste("Q:/Research/All_Projects_by_Species/Astragalus SPECIES/Astragalus_microcymbus/Asmi_Excel/Yearly Summaries/", currentyr,"_asmi/", collapse = '', sep = '')
...
```{r}
plotdatapath <- # paste("Q:/Research/All_Projects_by_Species/Astragalus SPECIES/Astragalus_microcymbus/Asmi_Excel/Yearly Summaries/"
  paste("C:/Users/DePrengm/Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Astragalus microcymbus/Astragalus-microcymbus_Data/",
...
```{r}
library(lme4) # don't need to do mixed random effects models
# 2020 report
ps.asmi.reduced <- ps.asmi[!is.na(ps.asmi$Total.Alive),]
# Methods say exclude Cebolla for whole time, then no creek
# ps.asmi.reduced <- ps.asmi[!is.na(ps.asmi$Total.Alive) & ps.asmi$Site > 4,]
...
# jpeg(paste(savepath,
#               # currentyr,"_asmi/",
#            "Fig2-latticeplot_6Sites_after2013.jpg", sep = ""),
#          units = "mm", res = 300, height = 200, width = 250)


xyplot(Total.Alive ~ Year|as.factor(Site), ps.asmi[ps.asmi$Year > 2013,],
# xyplot(Total.Alive ~ Year + as.factor(Site)|as.factor(Plot), ps.asmi[ps.asmi$Year > 2013,],
       type = c("g","p","r"),
       layout = c(2, 3),
       index.cond = list(1:6),
       as.table = TRUE,
...
```{r}
# jpeg(paste("Q:/Research/All_Projects_by_Species/Astragalus SPECIES/Astragalus_microcymbus/Asmi_Excel/Yearly Summaries/",
#               currentyr,"_asmi/","Fig3a-d_SouthBeaverCreek.jpg", sep = ""),
#          units = "mm", res = 300, height = 200, width = 200)
