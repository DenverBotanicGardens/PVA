...
t.test(Total.Plants~Fence, data = ps.asmi[ps.asmi$Year > 2005,])
t.test(Total.Plants~Fence, data = ps.asmi)

#herbivory
t.test(X..Browsed~Fence, data = ps.asmi[ps.asmi$Year > 2005,]) #not signficantly different
lapply(1995:currentyr, function(x){
  t.test(X..Browsed~Fence, data = ps.asmi[ps.asmi$Year == x,])
})
