...
foo <- dcast(asmi.c.wide, Date+Site+Plot~variable, max )
...
```{r}
#Candidate models  
lm1 <- lm(Total.Alivelog.y ~ X..Browsedarcsinsqrttransformed.x+ # browse stress prev yr
            Total.Fruitlogtransformed.x +  # fruit previous year 
            X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=asmi.c.ps.asmi)
#only fruit last year
lm2 <- lm(Total.Alivelogtransformed.y ~ Total.Fruitlogtransformed.x, data=asmi.c.ps.asmi)
# only browsed last year
lm3 <- lm(Total.Alivelogtransformed.y ~ X..Browsedarcsinsqrttransformed.x, data=asmi.c.ps.asmi)
# nothing
lm4 <- lm(Total.Alivelogtransformed.y ~ 1, data=asmi.c.ps.asmi)
# lm1 also alive last year
lm5 <- lm(Total.Alivelogtransformed.y ~ Total.Alivelogtransformed.x+
            X..Browsedarcsinsqrttransformed.x +
            Total.Fruitlogtransformed.x + X..Flowered.y, 
...
lm7 <- lm(Total.Alivelogtransformed.y ~ Total.Alivelogtransformed.x+ #total AGG last year
            ...
            X..Browsedarcsinsqrttransformed.y, data=asmi.c.ps.asmi)
# only fenced
lm8 <- lm(Total.Alivelogtransformed.y ~ Fence.x, data=asmi.c.ps.asmi)
# browsed last year, fruit this year
lm9 <- lm(Total.Alivelogtransformed.y ~ X..Browsedarcsinsqrttransformed.x+ # browse stress prev yr
            Total.Fruitlogtransformed.x,  # fruit previous year 
          data=asmi.c.ps.asmi)
