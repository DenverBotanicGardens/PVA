...
#Candidate models  
glm1 <- glm(FlYN ~ ppt_fall + ppt_springSummer + ppt_winter + tmax_fall+tmax_springSummer +
tmax_winter+tmin_fall+tmin_springSummer + tmin_winter, family = poisson(link = 'log'), data = asmi.reproductive)
glm2 <- glm(FlYN ~ ppt_fall + ppt_springSummer + ppt_winter + tmax_springSummer +
              tmin_winter , family = poisson(link = 'log'), data = asmi.reproductive)
glm3 <- glm(FlYN ~ ppt_winter + tmax_springSummer +
              tmin_winter , family = poisson(link = 'log'), data = asmi.reproductive) #Need add creek!
glm4 <- glm(FlYN ~ ppt_springSummer, family = poisson(link = 'log'), data = asmi.reproductive)
glm5 <- glm(FlYN ~ 1, family = poisson(link = 'log'), data = asmi.reproductive)
glm6 <- glm(FlYN ~ ppt_winter, family = poisson(link = 'log'), data = asmi.reproductive)
glm7 <- glm(FlYN ~ tmax_springSummer, family = poisson(link = 'log'), data = asmi.reproductive) 
glm8 <- glm(FlYN ~ ppt_fall, family = poisson(link = 'log'), data = asmi.reproductive)
