...
Veg -> seedling?
Did some get marked as fruit and no flower because only fruit was on at that time? 
### START HERE### should change in the database
```{r}
asmi.raw[asmi.raw$flower == 0 & asmi.raw$fruit > 0 &
           !is.na(asmi.raw$fruit),]
