...
aggregate(asmi.c, list(Creek=asmi.c$Creek), function(x) mean(x)) #Average monthly... 
sort(unique(asmi.c$Year))

# first add by all prev12 then average all by creek
# Precipitation
prev12clim <- aggregate(asmi.c$Precip, list(Creek=asmi.c$Creek, Site=asmi.c$Site, 
                                     Plot=asmi.c$Plot, Year=asmi.c$Prev12),
                        function(x) sum(x)) # Only want to sum ppt, not tmin and tmax 
aggregate(prev12clim$x, list(prev12clim$Creek), mean)
aggregate(prev12clim$x[prev12clim$Year>1995], list(prev12clim$Creek[prev12clim$Year>1995]), mean)

# Temperature
prev12clim <- aggregate(asmi.c$tmin, list(Creek=asmi.c$Creek, Site=asmi.c$Site, 
                                     Plot=asmi.c$Plot, Year=asmi.c$Prev12),
                        function(x) mean(x)) # Only want to sum ppt, not tmin and tmax 
aggregate(prev12clim$x, list(prev12clim$Creek), mean)
aggregate(prev12clim$x[prev12clim$Year>1995], list(prev12clim$Creek[prev12clim$Year>1995]), mean)

prev12clim <- aggregate(asmi.c$tmax, list(Creek=asmi.c$Creek, Site=asmi.c$Site, 
                                     Plot=asmi.c$Plot, Year=asmi.c$Prev12),
                        function(x) mean(x)) # Only want to sum ppt, not tmin and tmax 
aggregate(prev12clim$x, list(prev12clim$Creek), mean)
aggregate(prev12clim$x[prev12clim$Year>1995], list(prev12clim$Creek[prev12clim$Year>1995]), mean)
...
lm1 <- lm(Lmda ~ Precip.fall + Precip.winter + tmax.winter, aic.asmi)
lm2 <- lm(Lmda ~ Precip.springSummer, aic.asmi)
lm3 <- lm(Lmda ~ tmin.winter + tmax.springSummer, aic.asmi) 
lm4 <- lm(Lmda ~ Precip.winter, aic.asmi)
lm5 <- lm(Lmda ~ 1, aic.asmi)
lm6 <- lm(Lmda ~ Site, aic.asmi)

lm7 <- lm(Lmda ~ Prev12, aic.asmi)
...
lm1 <- lm(Lmda ~ Precip.fall + Precip.winter + tmax.winter, season)
lm2 <- lm(Lmda ~ Precip.springSummer, season)
lm3 <- lm(Lmda ~ tmin.winter + tmax.springSummer, season) 
lm4 <- lm(Lmda ~ Precip.winter, season)
lm5 <- lm(Lmda ~ 1, season)

lm6 <- lm(Lmda ~ Precip.fall, season)

lm7 <- lm(Lmda ~ tmax.fall, season)

lm8 <- lm(Lmda ~ tmax.springSummer, season)

lm9 <- lm(Lmda ~ (Precip.fall + Precip.winter + tmax.winter)^2, season)
