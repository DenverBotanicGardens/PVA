...
`AGGpersurvey.14 <- lapply(unique(AGG14$Plot), function(x){
  sapply(unique(AGG14$Survey), function(y){
    length(unique(AGG14$X[AGG14$Ln>0 & 
                         AGG14$Plot == x & 
                         AGG14$Survey == y]))/length(unique(AGG14$X[AGG14$Ln>0 & 
                                                               AGG14$Plot == x]))
  })
})`
```{r}
...
AGGpersurvey.15 <- lapply(unique(AGG15$Plot), function(x){
  sapply(unique(AGG15$Survey), function(y){
    length(unique(AGG15$X[AGG15$Ln>0 & 
                         AGG15$Plot == x & 
                         AGG15$Survey == y]))/length(unique(AGG15$X[AGG15$Ln>0 & 
                                                               AGG15$Plot == x]))
  })
})
