...
```{r}
cor.plot(cor(ps.cor[,grep("transformed", names(ps.cor))]),
         numbers=TRUE)
```
...
lm2 <- lm(Total.Alivelogtransformed.y ~ Year.x*Site, ps.cor)
#lm3 <- lm(Total.Alivelogtransformed.y ~ Year.x*Creek, ps.cor) #Need add creek!
...
```{r}
#Candidate models  
lm1 <- lm(Total.Alivelogtransformed.y ~ X..Browsedarcsinsqrttransformed.x+ # browse stress prev yr
            Total.Fruitlogtransformed.x +  # fruit previous year 
            X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=ps.cor)
#only fruit last year
lm2 <- lm(Total.Alivelogtransformed.y ~ Total.Fruitlogtransformed.x, data=ps.cor)
# only browsed last year
lm3 <- lm(Total.Alivelogtransformed.y ~ X..Browsedarcsinsqrttransformed.x, data=ps.cor)
# nothing
lm4 <- lm(Total.Alivelogtransformed.y ~ 1, data=ps.cor)
# lm1 also alive last year
lm5 <- lm(Total.Alivelogtransformed.y ~ Total.Alivelogtransformed.x+
            X..Browsedarcsinsqrttransformed.x +
            Total.Fruitlogtransformed.x + X..Flowered.y, 
          data=ps.cor)
# lm4 and browsed this year
lm6 <- lm(Total.Alivelogtransformed.y ~ Total.Alivelogtransformed.x+
            X..Browsedarcsinsqrttransformed.x +
            Total.Fruitlogtransformed.x + X..Flowered.y +
            X..Browsedarcsinsqrttransformed.y, data=ps.cor)
# and alive given browsed last year
lm7 <- lm(Total.Alivelogtransformed.y ~ Total.Alivelogtransformed.x+ #total AGG last year
            X..Browsedarcsinsqrttransformed.x + #amount of damage last year (that would stress)
            Total.Alivelogtransformed.x*X..Browsedarcsinsqrttransformed.x + #The total AGG given amount of stress
            Total.Fruitlogtransformed.x + X..Flowered.y +
            X..Browsedarcsinsqrttransformed.y, data=ps.cor)
# only fenced
lm8 <- lm(Total.Alivelogtransformed.y ~ Fence.x, data=ps.cor)
# browsed last year, fruit this year
lm9 <- lm(Total.Alivelogtransformed.y ~ X..Browsedarcsinsqrttransformed.x+ # browse stress prev yr
            Total.Fruitlogtransformed.x,  # fruit previous year 
          data=ps.cor)
# browsed last year and fence
lm10 <- lm(Total.Alivelogtransformed.y ~ 
             X..Browsedarcsinsqrttransformed.x + Fence.x, # browse stress prev yr
          data=ps.cor)
# fruit last year flower this year
lm11 <- lm(Total.Alivelogtransformed.y ~ Total.Fruitlogtransformed.x +  # fruit previous year 
            X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=ps.cor)
# flower percentthis year
lm12 <- lm(Total.Alivelogtransformed.y ~ X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=ps.cor)
...
#Candidate models  
lm1 <- lm(Total.Fruitlogtransformed.y ~ X..Browsedarcsinsqrttransformed.x+ # browse stress prev yr
            Total.Fruitlogtransformed.x +  # fruit previous year 
            X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=ps.cor)
#only fruit last year
lm2 <- lm(Total.Fruitlogtransformed.y ~ Total.Fruitlogtransformed.x, data=ps.cor)
# only browsed last year
lm3 <- lm(Total.Fruitlogtransformed.y ~ X..Browsedarcsinsqrttransformed.x, data=ps.cor)
# nothing
lm4 <- lm(Total.Fruitlogtransformed.y ~ 1, data=ps.cor)
# lm1 also alive last year
lm5 <- lm(Total.Fruitlogtransformed.y ~ Total.Alivelogtransformed.x+
            X..Browsedarcsinsqrttransformed.x +
            Total.Fruitlogtransformed.x + X..Flowered.y, 
          data=ps.cor)
# lm4 and browsed this year
lm6 <- lm(Total.Fruitlogtransformed.y ~ Total.Alivelogtransformed.x+
            X..Browsedarcsinsqrttransformed.x +
            Total.Fruitlogtransformed.x + X..Flowered.y +
            X..Browsedarcsinsqrttransformed.y, data=ps.cor)
# and alive given browsed last year
lm7 <- lm(Total.Fruitlogtransformed.y ~ Total.Alivelogtransformed.x+ #total AGG last year
            X..Browsedarcsinsqrttransformed.x + #amount of damage last year (that would stress)
            Total.Alivelogtransformed.x*X..Browsedarcsinsqrttransformed.x + #The total AGG given amount of stress
            Total.Fruitlogtransformed.x + X..Flowered.y +
            X..Browsedarcsinsqrttransformed.y, data=ps.cor)
# only fenced
lm8 <- lm(Total.Fruitlogtransformed.y ~ Fence.x, data=ps.cor)
# browsed last year, fruit this year
lm9 <- lm(Total.Fruitlogtransformed.y ~ X..Browsedarcsinsqrttransformed.x+ # browse stress prev yr
            Total.Fruitlogtransformed.x,  # fruit previous year 
          data=ps.cor)
# browsed last year and fence
lm10 <- lm(Total.Fruitlogtransformed.y ~ 
             X..Browsedarcsinsqrttransformed.x + Fence.x, # browse stress prev yr
          data=ps.cor)
# fruit last year flower this year
lm11 <- lm(Total.Fruitlogtransformed.y ~ Total.Fruitlogtransformed.x +  # fruit previous year 
            X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=ps.cor)
# flower percentthis year
lm12 <- lm(Total.Fruitlogtransformed.y ~ X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=ps.cor)
...
#x = t, y = t+1
# X..Flowered.1 = density; X..Flowered = % reproductive  
#Total.Alive = AGG; Total.Plants=AGG+Dormant
#write.table(cor.out, file=paste(savepath,"Table2_correlations.csv"), sep=",",row.names = TRUE, col.names = TRUE)
...
cebolla.2 <- cebolla[, names(cebolla) %in% unique(grep(paste(cols,collapse="|"),
                                                  names(cebolla), value = TRUE))]
...
asmi.boot <- asmi.2
#add 'seedling' filed
asmi.boot$seedling <- do.call(c,lapply(unique(asmi.boot$year),function(year){
  seedlings <- nrow(asmi.boot[asmi.boot$year == year & asmi.boot$stage == "seedling",])
  seedlingsout <- asmi.boot$fruits[asmi.boot$year==year]/sum(asmi.boot$fruits[asmi.boot$year==year],na.rm = TRUE) * seedlings
  seedlingsout
  }))

boottrans <- lapply(unique(asmi.boot$site), function(x){
  data.frame(cbind(Site = x,
                   Boot = boot.transitions(asmi.boot[asmi.boot$site == x & 
                                                       asmi.boot$fenced == "n",], 
                                           1000,
...
table(firststage$stage[firststage$year != 1996]) # 11 times when first account of tagged individual is vegetative, not seedling, why?!
...
dorms <- do.call(c,lapply(split(asmi.1, asmi.1$AsMi_tag_id), function(x){
  rle(as.numeric(x$status))$lengths[rle(as.numeric(x$status))$values==4]
}))
...
```{r}
median(dorms) #3
length(dorms[dorms==1]) #347
length(dorms[dorms==1])/length(dorms) # 37%
length(dorms) #848
length(dorms[dorms > 5]) #353
length(dorms[dorms > 15]) #93
length(dorms[dorms == 21]) #13
```

Reproductive lengths - South Beaver Creek only   
```{r}
repros <- rle(as.numeric(asmi.2$fate))$lengths[rle(as.numeric(asmi.2$fate))$values ==3]
max(repros)
...
get_prism_monthlys(type="ppt", mon = 1:12, keepZip = FALSE, years = 1994:currentyr)

#Maximum temperature (average)
get_prism_monthlys(type="tmax", mon = 1:12, keepZip = FALSE, years = 1994:currentyr)

#Minimum temperature (average)
get_prism_monthlys(type="tmin", mon = 1:12, keepZip = FALSE, years = 1994:currentyr)
...
plots.site$Creek <- "South Beaver"b
...
#AIC with climate and biotic variables   
#Need to cast each month on it's own to use in AIC
```{r}
#need wide asmi.c climate  
#asmi.c2 <-within(asmi.c, Date <- sprintf("%d-%02d", Prev12, Month))
asmi.c2 <- asmi.c
asmi.c2$Date <- as.Date(paste(sprintf("%d-%02d", asmi.c2$Prev12, asmi.c2$Month), 
                              1, sep="-"), "%Y-%m-%d") 

names(asmi.c2) <- c(names(asmi.c2)[1:4], "SiteName", names(asmi.c2)[6:length(asmi.c2)])

#Need to cast by month make years stick for Prev12 so 8:12 to with next year 
# This gets me a 'variable' column with tmin, tmax, Precip, and a 'value' column with the value
names(asmi.c)[5] <- "SiteName"
asmi.cast <- melt(asmi.c, 
                    id = c("Plot","Site","Creek","SiteName",
                           "Year","Month","Prev12"))
asmi.cast <- dcast(asmi.cast, Plot+Site+Creek+SiteName+Year+Prev12~Month+variable)

#Need to rename 1:12 as Jan:Dec
mons <- c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec")
names(asmi.cast)[7:42] <- paste(rep(mons,each=3),names(asmi.cast)[7:42],sep="_")

asmi.cast1.7 <- asmi.cast[asmi.cast$Year==asmi.cast$Prev12,]
asmi.cast8.12 <- asmi.cast[asmi.cast$Year!=asmi.cast$Prev12,]

asmi.cast.foo <- merge(asmi.cast1.7[,1:27],
                       asmi.cast8.12[,c(1:6,28:length(asmi.cast8.12))], 
                       by= c("Plot", "Site", "Creek", "SiteName","Prev12"))
```

```{r}
#Merging in two rows for each Plot and Site for months 1:7 and another for months 8:12! Yargg
asmimerg <- merge(ps.asmi.t, asmi.cast.foo,
                        by.x = c("Year","Plot","Site"),
                        by.y = c("Prev12","Plot","Site"))

#Possible variables exlaining Percent reproductive; X..Flowered
ggplot(asmimerg, aes(as.factor(Site),X..Floweredlogtransformed))+
  geom_boxplot()+
  geom_rug()+
  theme_bw()

ggplot(asmimerg, aes(as.factor(Site),X..Browsedarcsinsqrttransformed))+
  geom_boxplot()+
  geom_rug()+
  theme_bw()

ggplot(asmimerg, aes(as.factor(Site),X..Browsed))+
  geom_boxplot()+
  geom_rug()+
  theme_bw()
...
```{r}
#need apply all combination of numbers of variable columns that explain percent reproductive
#Should merge for lag years too and then interaction with last and previous year


#
asmimerglag <- subset(merge(asmimerg, asmimerg,
                      by=c("Plot","Site")),
                      Year.x == Year.y-1)

namesasmi <- names(asmimerglag)
exclude <- c("Fence","Plot","Site","Year","Creek","SiteName","Dormant",
             "Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","logtrans","Plants",
             "arcsinsqrttransformed","Browsed",
             "Flowered.1")  #flowered.1 is the number of reproductive, other is percent
namesasmi[-grep(paste(exclude, collapse="|"),
                      namesasmi)]

#All combinations for Total.Alive.x
x<-namesasmi[-grep(paste(exclude, collapse="|"),
                   namesasmi)]
x<-x[-1]
#ind <- which(namesasmi %in% x)
#variables <- lapply(1:length(x), function(pick) combn(x, pick))

gc() #garbage collect, clean up memory

# X..Flowered.x (current year); .y is previous year
```


```{r}
lm5.alive <- lm(Total.Alive.x~.+.^2, asmimerglag[,c("Total.Alive.x",x)])
lm1.alive <- lm(as.formula(paste("Total.Alive.x~", paste(x[5:16], collapse="+"))),
                data=asmimerglag)
lm2.alive <- lm(Total.Alive.x~., asmimerglag[,c("Total.Alive.x",
                                                x[-grep(paste(c("Flower","Fruit","Brow"),
                                                              collapse="|"),x)])])
lm3.alive <- lm(Total.Alive.x~., asmimerglag[,c("Total.Alive.x",
                                      x[-grep(paste(c("Flower","Fruit","Brow",".y"),
                                                collapse="|"),x)])]) #Only prev 12 weather winter
lm6.alive <- lm(Total.Alive.x~., asmimerglag[,c("Total.Alive.x",x)]) #Oct to Jan climate, percent flowered, fruit, percent browsed, and previous year
lm4.alive <- lm(Total.Alive.x~.+.^2,asmimerglag[,c("Total.Alive.x",
                                      x[-grep(paste(c("Flower","Fruit","Brow",".y"),
                                                collapse="|"),x)])]) #only previous 12 and all interactions
lm7.alive <- lm(Total.Alive.x~., asmimerglag[,c("Total.Alive.x",x[c(1:4,17:19)])]) #only biotic
lm8.alive <- lm(Total.Alive.x~.+.^2,asmimerglag[,c("Total.Alive.x",
                                      x[grep(paste(c("Flower","Fruit","Brow"),
                                                collapse="|"),x)])]) #only abiotic current and last year and interactions
lm9.alive <- lm(Total.Alive.x~.+.^2, asmimerglag[,c("Total.Alive.x",x[grep("Precip",x)])]) #only precip
lm10.alive <- lm(Total.Alive.x~., asmimerglag[,c("Total.Alive.x",
          namesasmi[grep(paste(c("8_Precip","9_Precip","10_Precip","11_Precip", #fall precip
                  "12_tmin","1_tmin","2_tmin","3_tmin", #winter min
                  "4_Precip","5_Precip","6_Precip","7_Precip") # spring/sum precip 2015 PCA
                  ,collapse="|"),namesasmi)])])
...
lm.list <- list(lm1.alive,lm2.alive,lm3.alive,lm4.alive,lm5.alive,
                lm6.alive,lm7.alive,lm8.alive,lm9.alive,lm10.alive) #,lm11,lm12)


(lm.results <- aictab(lm.list, modnames=c("lm1.alive","lm2.alive","lm3.alive",
                                          "lm4.alive","lm5.alive","lm6,alive",
                                          "lm7.alive","lm8.alive","lm9.alive",
                                          "lm10.alive")))
...
```{r}
ggplot(asmimerglag, aes(X..Flowered.y))+
  geom_histogram()+
  facet_wrap(~Site)+
  theme_bw()

ggplot(asmimerglag, aes(X..Floweredlogtransformed.y))+
  geom_histogram()+
  facet_wrap(~Site)+
  theme_bw()


head(asmimerglag[,grep("Year",names(asmimerglag))]) 
# .x    = year t
# .x.x  = year t
# .y.x  = year t-1 <- refers to the actual year of the Aug:dec climate for .x 
# .y    = year t+1
# .x.y  = year t+1
# .y.y  = year t <- for .y cliamte is the actual year
...
#Climate only for percent reproductive, not log transformed 
```{r}  

per.fl <- grep("X..Flowered.y",names(asmimerglag))
climate.variables <- c("tmin","tmax","Precip") 
current.climate.var <- c("tmin.y","tmax.y","Precip.y")
climate.var.2013 <- c("12_t","1_t","2_t","3_t","4_t","5_t","6_t","7_t")
climate.var.2014.cur <- c("Precip.y")
climate.var.2014.both <- c("Precip")
climate.var.2015.pc1 <- c("8_P","9_P","10_P","11_P",
                      "12_tmi","1_tmi","2_tmi","3_tmi",
                      "4_P","5_P","6_P","7_P")
climate.var.2015.pc2 <- c("8_tma","9_tma","10_tma","11_tma",
                      "8_tmi","9_tmi","10_tmi","11_tmi",
                      "12_P","1_P","2_P","3_P")

climate.var.2016.pc1 <- c("8_tma","9_tma","10_tma","11_tma",
                          "4_tmi","5_tmi","6_tmi","7_tmi")

climate.var.2016.pc2 <- c("8_tmi","9_tmi","10_tmi","11_tmi",
                          "8_P","9_P","10_P","11_P",
                          "12_P","1_P","2_P","3_P",
                          "12__tma","1__tma","2__tma","3__tma")


climate.var.2017.pc1 <- c("8_t","9_t","10_t","11_t")
climate.var.2017.pc2 <- c("8_P","9_P","10_P","11_P",
                          "12_P","1_P","2_P","3_P")


#Candidate models  
#lm1 is the current and previous year's monthly climate varaibles
lm1 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.variables),collapse="|"),
                                   names(asmimerglag))])
#lm2 only recent climate
lm2 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",current.climate.var),collapse="|"),
                                   names(asmimerglag))])
# only browsed last year
#lm3 is the current and previous year's monthly climate varaibles and interactions
lm3 <- lm(X..Flowered.y ~ .+.^2, 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.variables),collapse="|"),
                                   names(asmimerglag))])
# nothing
#lm4 only recent climate and interactions
lm4 <- lm(X..Flowered.y ~ .+.^2, 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",current.climate.var),collapse="|"),
                                   names(asmimerglag))])
# lm5 is 2013 variables for the last couple years
lm5 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.var.2013),collapse="|"),
                                   names(asmimerglag))])
# lm6 2013 only prev 12 months
lm6 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(".y",grep(paste(c("X..Flowered.y",climate.var.2013),
                                                 collapse="|"),
                                   names(asmimerglag), value=TRUE), value=TRUE)])

# lm6 2013 only prev 12 months of previous year, lag? 
lm13 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,c("X..Flowered.y",grep(".x",grep(paste(c("X..Flowered.y",climate.var.2013),
                                                 collapse="|"),
                                   names(asmimerglag), value=TRUE), value=TRUE))])


# lm7 2014 only prev 12
lm7  <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.var.2014.cur),
                                       collapse="|"),
                                   names(asmimerglag))])
# lm8 2014 both previous years
lm8  <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.var.2014.both),
                                       collapse="|"),
                                   names(asmimerglag))])

# 2015 pc1
lm9 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.var.2015.pc1),
                                       collapse="|"),
                                   names(asmimerglag))])
# 2015 pc2
lm10 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.var.2015.pc2),
                                       collapse="|"),
                                   names(asmimerglag))])
# 2016 pc1
lm11 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.var.2016.pc1),
                                       collapse="|"),
                                   names(asmimerglag))])
# 2016 pc2
lm12 <- lm(X..Flowered.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.y",climate.var.2016.pc2),
                                       collapse="|"),
                                   names(asmimerglag))])

lm14 <- lm(X..Flowered.y ~ 1, data=asmimerglag)

lm.list <- list(lm1,lm2,lm3,lm4,lm5,lm6,lm7,lm8,lm9,lm10,lm11,lm12,lm13, lm14)
lm.names <- c("lm1","lm2","lm3","lm4","lm5","lm6","lm7","lm8","lm9","lm10",
              "lm11","lm12","lm13","lm14")
(lm.results <- aictab(lm.list, modnames=lm.names))
...
#Now explore model 13? Can't do all iterations. 
```{r}
varcol.lm6 <- grep(".y",names(asmimerglag[,grep(paste(c("X..Flowered.y",
                                                 climate.var.2013),collapse="|"),
                                                 names(asmimerglag))]), value = TRUE)
variables.lm6 <- lapply(1:length(varcol.lm6), function(pick) combn(varcol.lm6,pick))

length(variables.lm6[[2]])


varcol.lm13 <- grep(".x",names(asmimerglag[,grep(paste(c("X..Flowered.y",
                                                 climate.var.2013),collapse="|"),
                                                 names(asmimerglag))]),value=TRUE)
variables.lm13 <- lapply(1:length(varcol.lm13), function(pick) combn(varcol.lm13,pick))

length(variables.lm13[[2]])
gc()
...
#Climate and monthly weather 
```{r}
#Candidate models  
lm1 <- lm(Total.Alivelog.y ~ Total.Alivelog.y+X..Browsedlog.y+X..Floweredlog.y+
            Fence.x+Total.Fruitlog.y+X..Flowered.1log.x+Total.Fruitlog.x,
          data=asmimerg)
#only fruit last year
lm2 <- lm(Total.Alivelog.y ~ Total.Fruitlogtransformed.x, data=asmimerg)
# only browsed last year
lm3 <- lm(Total.Alivelog.y ~ X..Browsedarcsinsqrttransformed.x, data=asmimerg)
# nothing
lm4 <- lm(Total.Alivelog.y ~ 1, data=asmimerg)
# lm1 also alive last year
lm5 <- lm(Total.Alivelog.y ~ Total.Alivelogtransformed.x+
            X..Browsedarcsinsqrttransformed.x +
            Total.Fruitlogtransformed.x + X..Flowered.y, 
          data=asmimerg)
# lm4 and browsed this year
lm6 <- lm(Total.Alivelog.y ~ Total.Alivelogtransformed.x+
            X..Browsedarcsinsqrttransformed.x +
            Total.Fruitlogtransformed.x + X..Flowered.y +
            X..Browsedarcsinsqrttransformed.y, data=asmimerg)
# and alive given browsed last year
lm7 <- lm(Total.Alivelog.y ~ Total.Alivelogtransformed.x+ #total AGG last year
            X..Browsedarcsinsqrttransformed.x + #amount of damage last year (that would stress)
            Total.Alivelogtransformed.x*X..Browsedarcsinsqrttransformed.x + #The total AGG given amount of stress
            Total.Fruitlogtransformed.x + X..Flowered.y +
            X..Browsedarcsinsqrttransformed.y, data=asmimerg)
# only fenced
lm8 <- lm(Total.Alivelog.y ~ Fence.x, data=asmimerg)
# browsed last year, fruit this year
lm9 <- lm(Total.Alivelog.y ~ X..Browsedarcsinsqrttransformed.x+ # browse stress prev yr
            Total.Fruitlogtransformed.x,  # fruit previous year 
          data=asmimerg)
# browsed last year and fence
lm10 <- lm(Total.Alivelog.y ~ 
             X..Browsedarcsinsqrttransformed.x + Fence.x, # browse stress prev yr
          data=asmimerg)
# fruit last year flower this year
lm11 <- lm(Total.Alivelog.y ~ Total.Fruitlogtransformed.x +  # fruit previous year 
            X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=asmimerg)
# flower percentthis year
lm12 <- lm(Total.Alivelog.y ~ X..Flowered.y, # flowering current year (how many strong/big reproductive)
          data=asmimerg)
...
```{r}
asmi.c$season <- "winter"   #Dec t-1 to March t
asmi.c[asmi.c$Month>3 & asmi.c$Month<8, "season"] <- "springSummer" #April - July t
asmi.c[asmi.c$Month>7 & asmi.c$Month<12, "season"] <- "fall"        #August to November t-1

asmi.c.summary <- aggregate(asmi.c[,grep(paste(c("tmin","tmax","Precip"),collapse="|"),
                                          names(asmi.c))], 
                            asmi.c[,c("season","Creek","Prev12")],
                            FUN = function(x) mean(x))
head(asmi.c, 100)
head(asmi.c.summary,100) #Should have spring/summer and one month for winter for 1980 :) 
...
#AIC variable selection with seasons instead of months
```{r}

meltclimateseason <- melt(asmi.c, 
                          id = c("Plot","Site","Creek","SiteName",
                                 "Year","season","Prev12","Month"))
table(meltclimateseason$variable)

asmi.cast.plot <- dcast(meltclimateseason, 
                        Plot+Site+Creek+SiteName+Prev12~season+variable,mean)

asmimerglagseason <- merge(ps.asmi.t, asmi.cast.plot[complete.cases(asmi.cast.plot),], 
                           by.x = c("Plot","Site","Year"),
                           by.y = c("Plot","Site","Prev12"))

asmimerglagseason<- subset(merge(asmimerglagseason, asmimerglagseason,
                                 by=c("Plot","Site")),
                           Year.x == Year.y-1)

save(asmimerglagseason, file = "P:/hackathon/GitPVA/datasets/asmimerglagseason.csv")
```

#AIC climate seasons only for percent reproductive, not log transformed   
```{r}
per.fl <- grep("X..Flowered.y",names(asmimerglagseason))
season2013 <- c("winter_t","Summer_t") #all split
season2014 <- c("Precip") #All split
season2015pc1 <- c("fall_P","winter_tmin","Summer_P") #non split
season2015pc2 <- c("fall_t","winter_P") #Mast seeding
season2016pc1 <- c("fall_tma","Summer_tmi")
season2016pc2 <- c("fall_tma","fall_P","winter_P","winter_tma")
season2017pc1 <- c("fall_t")
season2017pc2 <- c("fall_P","winter_P")

#Models
# winter and summer high and low temperatures the last couple years, all interactions
lm1 <- lm(X..Flowered.y ~ .+.^2, 
          data=asmimerglagseason[,grep(paste(c("X..Flowered.y",season2013),
                                             collapse="|"),names(asmimerglagseason))])
# winter sumer temps no interactions
lm2 <- lm(X..Flowered.y ~ ., 
          data=asmimerglagseason[,grep(paste(c("X..Flowered.y",season2013),
                                             collapse="|"),names(asmimerglagseason))])
# winter summer temps, only current year
lm3 <- lm(X..Flowered.y ~ .+.^2, 
          data=asmimerglagseason[,grep(".y",
                names(asmimerglagseason)[grep(paste(c("X..Flowered.y",
                                                season2013),
                                              collapse="|"),
                                        names(asmimerglagseason))], value=TRUE
                )])
# winter summer temps, only current no interactions
lm4 <- lm(X..Flowered.y ~ ., 
          data=asmimerglagseason[,grep(".y",
                names(asmimerglagseason)[grep(paste(c("X..Flowered.y",
                                                season2013),
...
# winter summer temps, only last year
lm3 <- lm(X..Flowered.y ~ .+.^2, 
          data=asmimerglagseason[,c("X..Flowered.y",grep(".x",
                names(asmimerglagseason)[grep(paste(season2013,
                                              collapse="|"),
                                        names(asmimerglagseason))], value=TRUE
                ))])
# winter summer temps, only last no interactions
lm4 <- lm(X..Flowered.y ~ ., 
          data=asmimerglagseason[,c("X..Flowered.y",
                  grep(".y",grep(paste(season2013,collapse="|"),
                     names(asmimerglagseason),value=TRUE),invert=TRUE, 
                     value=TRUE))])


lm.list <- list(lm1,lm2,lm3,lm4) #,lm5,lm6,lm7,lm8,lm9,lm10,lm11,lm12)
lm.names <- c("lm1","lm2","lm3","lm4")
#,"lm5","lm6","lm7","lm8","lm9","lm10","lm11","lm12","lm13","lm14")
(lm.results <- aictab(lm.list, modnames=lm.names))
...
```{r}
seasonvariables.1 <- grep(paste(c("_t","_P"), collapse="|"),
                              names(asmimerglagseason), value=TRUE)

seasonvariables <- lapply(1:(length(seasonvariables.1)-10), 
                          function(pick) combn(seasonvariables.1, pick))

(seasonvariables[[2]][,1])

lm.listseason <- lapply(1:(length(seasonvariables[[2]])/2), function(x){
  lm(X..Flowered.y ~ .,
     data=asmimerglagseason[,c("X..Flowered.y",seasonvariables[[2]][,x])])
})

lm.namesseason <- as.character(unlist(lapply(lm.listseason, formula)))
(lm.results <- aictab(lm.listseason, modnames=lm.namesseason))


#Evidence ratio
for(i in 2:length(lm.listseason)){
  print(exp(0.5*lm.results$Delta_AICc[i]))
}


dim(seasonvariables[[3]])
lm.listseason3 <- lapply(1:(dim(seasonvariables[[3]])[2]), function(x){
  lm(X..Flowered.y ~ .,
     data=asmimerglagseason[,c("X..Flowered.y",seasonvariables[[3]][,x])])
})
lm.namesseason3 <- as.character(unlist(lapply(lm.listseason3, formula)))
(lm.results3 <- aictab(lm.listseason3, modnames=lm.namesseason3))

dim(seasonvariables[[7]])


dim(seasonvariables[[4]])
lm.listseason4 <- lapply(1:(dim(seasonvariables[[4]])[2]), function(x){
  lm(X..Flowered.y ~ .,
     data=asmimerglagseason[,c("X..Flowered.y",seasonvariables[[4]][,x])])
})
lm.namesseason4 <- as.character(unlist(lapply(lm.listseason4, formula)))
(lm.results4 <- aictab(lm.listseason4, modnames=lm.namesseason4))


### TOO BIG NOW   Ctrl+Shift+C
 dim(seasonvariables[[5]])
# lm.listseason5 <- lapply(1:(dim(seasonvariables[[5]])[2]), function(x){
#   lm(X..Flowered.y ~ .,
#      data=asmimerglagseason[,c("X..Flowered.y",seasonvariables[[5]][,x])])
# })
# lm.namesseason5 <- as.character(unlist(lapply(lm.listseason5, formula)))
# (lm.results5 <- aictab(lm.listseason5, modnames=lm.namesseason5))
...
ggplot(ps.asmi[ps.asmi$Total.Alive>0 & ps.asmi$Site > 3,], 
...
dm$TagperPlot <- paste(dm$tag,dm$Plot,dm$Dir, sep="")
asmi.raw$TagperPlot <- paste(asmi.raw$tag_no,asmi.raw$AsMi_plot_id,asmi.raw$direction,sep="")
