...
```
  ...
  scale_x_discrete(limits=rainbow(length(unique(dm$Survey))), 
                   labels = c("April 2014", "May 2014",'June-1',
                              'June-2','July','Aug','Sept',
                              'Oct-1','Oct-2',
                              "April 2015","May 11-15","May 26-28",
                              "June 8-10","June 22-24","July 20-23","Aug 12-14",
                              "Sept 1-3","Oct 6-8")) + 
...
levels(plotnum$Site) <- gsub("Cebolla Mid", "1",levels(plotnum$Site)) 
levels(plotnum$Site) <- gsub("Cebolla North", "2",levels(plotnum$Site)) 
