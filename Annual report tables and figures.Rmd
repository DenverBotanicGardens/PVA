...
```{r}
ggplot(asmimerglag, aes(X..Flowered.1.y))+
  geom_histogram()+
  facet_wrap(~Site)+
  theme_bw()

ggplot(asmimerglag, aes(X..Flowered.1logtransformed.y))+
  geom_histogram()+
  facet_wrap(~Site)+
  theme_bw()
...
per.fl <- grep("X..Flowered.1.y",names(asmimerglag))
...
lm1 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.variables),collapse="|"),
                                   names(asmimerglag))])
#lm2 only recent climate
lm2 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",current.climate.var),collapse="|"),
                                   names(asmimerglag))])
# only browsed last year
#lm3 is the current and previous year's monthly climate varaibles and interactions
lm3 <- lm(X..Flowered.1.y ~ .+.^2, 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.variables),collapse="|"),
                                   names(asmimerglag))])
# nothing
#lm4 only recent climate and interactions
lm4 <- lm(X..Flowered.1.y ~ .+.^2, 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",current.climate.var),collapse="|"),
                                   names(asmimerglag))])
# lm5 is 2013 variables for the last couple years
lm5 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2013),collapse="|"),
                                   names(asmimerglag))])
# lm6 2013 only prev 12 months
lm6 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(".y",grep(paste(c("X..Flowered.1.y",climate.var.2013),
                                                 collapse="|"),
                                   names(asmimerglag), value=TRUE), value=TRUE)])

# lm6 2013 only prev 12 months of previous year, lag? 
lm13 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,c("X..Flowered.1.y",grep(".x",grep(paste(c("X..Flowered.1.y",climate.var.2013),
                                                 collapse="|"),
                                   names(asmimerglag), value=TRUE), value=TRUE))])


# lm7 2014 only prev 12
lm7  <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2014.cur),
                                       collapse="|"),
                                   names(asmimerglag))])
# lm8 2014 both previous years
lm8  <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2014.both),
                                       collapse="|"),
                                   names(asmimerglag))])

# 2015 pc1
lm9 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2015.pc1),
                                       collapse="|"),
                                   names(asmimerglag))])
# 2015 pc2
lm10 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2015.pc2),
                                       collapse="|"),
                                   names(asmimerglag))])
# 2016 pc1
lm11 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2016.pc1),
                                       collapse="|"),
                                   names(asmimerglag))])
# 2016 pc2
lm12 <- lm(X..Flowered.1.y ~ ., 
          data=asmimerglag[,grep(paste(c("X..Flowered.1.y",climate.var.2016.pc2),
                                       collapse="|"),
                                   names(asmimerglag))])

lm14 <- lm(X..Flowered.1.y ~ 1, data=asmimerglag)
...
```{r}
varcol.lm6 <- grep(".y",names(asmimerglag[,grep(paste(c("X..Flowered.1.y",
...
varcol.lm13 <- grep(".x",names(asmimerglag[,grep(paste(c("X..Flowered.1.y",
                                                 climate.var.2013),collapse="|"),
                                                 names(asmimerglag))]),value=TRUE)
...
#AIC climate seasons only fo rpercent reproductive, not log transformed   
```{r}
per.fl <- grep("X..Flowered.1.y",names(asmimerglagseason))
...
lm1 <- lm(X..Flowered.1.y ~ .+.^2, 
          data=asmimerglagseason[,grep(paste(c("X..Flowered.1.y",season2013),
...
lm3 <- lm(X..Flowered.1.y ~ .+.^2, 
          data=asmimerglagseason[,c("X..Flowered.1.y",grep(".x",
