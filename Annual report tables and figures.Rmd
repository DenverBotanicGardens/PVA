...
m6 <- glm(flower ~ as.factor(Site), family = binomial(link = 'logit'), data = asmi.raw)
...
#Candidate models  
glm1 <- glm(X..Flowered ~ Year, family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,])
glm2 <- glm(X..Flowered ~ Year*as.factor(Site), family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,])
glm3 <- glm(X..Flowered ~ Year*Creek, family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,]) #Need add creek!
glm4 <- glm(X..Flowered ~ Year*Fence, family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,])
glm5 <- glm(X..Flowered ~ 1, family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,])
glm6 <- glm(X..Flowered ~ as.factor(Site), family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,])
glm7 <- glm(X..Flowered ~ Creek, family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,]) 
glm8 <- glm(X..Flowered ~ Fence, family = binomial(link = 'logit'), data = ps.asmi.reduced[ps.asmi.reduced$Year > 2013,])
