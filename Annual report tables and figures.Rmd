...
#Order still too much of a factor, should use model selection instead of stepwise regression
...
all.sum.mean <- tapply(all.summary$PercentAGG, all.summary$Survey, mean)
```
...
stripchart(all.summary$Survey, all.summary$PercentAGG, method="jitter")
```
