...
## Can fill with "." if first assign a true zero to times visited and not seen
obsmodel <- dataCJS %>%
...
obsmodelRobust <- obsmodel %>%
  unite(ch, Occ1:Occ10, sep = "") %>%
  arrange(Year) %>%
  group_by(Site, Plot, Tag) %>%
  summarise(ch = paste0(ch, collapse = ""))
  
  

save(obsmodel, file = "C:/Users/deprengm/OneDrive - Denver Botanic Gardens/P drive/hackathon/GitPVA/datasets/Robust3years.Rdata")
