...
First keep survival and recruitment constant and see how detection varies, but will vary by observer, by daily weather - but we didn't record and we don't go out when it's rainy. Each year  
...
run.asmi.det <- function(){
  Phi.dot = list(formula =  ~ 1)
  f.dot = list(formula =  ~ 1, fixed = list(index = p.indices, value = p.values))
