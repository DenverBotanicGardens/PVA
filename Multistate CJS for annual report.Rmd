...
CebollaMPMMid <- matrix(c(  MPMSiteMid$MPMremain[MPMSiteMid$stratum == "V"] *
                              S.strataSite$S.estimates[S.strataSite$Plot == 1 & S.strataSite$stratum == "V"], 
                            MPMSiteMid$MPMtransition[MPMSiteMid$stratum == "R"] *
                              S.strataSite$S.estimates[S.strataSite$Plot == 1 & S.strataSite$stratum == "R"] + 
                              f.mpm$f.estimates[f.mpm$Plot == 1],
                            MPMSiteMid$MPMtransition[MPMSiteMid$stratum == "V"] *
                              S.strataSite$S.estimates[S.strataSite$Plot == 1 & S.strataSite$stratum == "V"], 
                            MPMSiteMid$MPMremain[MPMSiteMid$stratum == "R"] *
                              S.strataSite$S.estimates[S.strataSite$Plot == 1 & S.strataSite$stratum == "R"]),
                     nrow = 2,
                     byrow = TRUE)
